...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  await deploy("BarrenWuffet", {
    from: deployer,
    args: [
      { platformFeeWallet: deployer, subscriberToPlatformFeePercentage: 0, managerToPlatformFeePercentage: 0 }, // subscriberToPlatformFeePercentage should be 0.69 and managerToPlatformFeePercentage should be 0.42
      trigWlHash,
      actWlHash,
